...
Агент и CI применяют последнюю версию внешней методологии. `.methodology.yml`
хранит только машинно-читаемый тип репозитория.
...
Сначала запусти policy-гейт последней версии методологии, затем `lint / test /
