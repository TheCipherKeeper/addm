...
таблицы `<methodology-repo>/docs/ARCHITECTURE.md`. Структура, допустимые
зависимости, владельцы портов и composition root изменению в сервисе не подлежат.

| Модуль | Язык | Канонический корень | Проверка границ |
|---|---|---|---|
