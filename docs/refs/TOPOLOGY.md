...
- **Методология** — все репозитории применяют её последнюю версию.
  `.methodology.yml` хранит только тип репозитория и версию собственной схемы;
  гейт использует тип для выбора применимых проверок.
