...
- `docs/` — канонические документы, руководство сопровождения и карта покрытия правил;
...
Продуктовый цикл канонически описан только в `docs/WORKFLOW.md`; обслуживание
этого репозитория — в `AGENTS.md` и `docs/MAINTENANCE.md`. Код
